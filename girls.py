...
try:
    ...
    cursor.execute("SELECT photo,toy_name,price,age_min,stock,id_num FROM toys WHERE toy_cat='Girls' ORDER BY id_num")
    result = """<table border='1'>
                <tr><th colspan="6">Girls Toys</th></tr>
...
<html lang="en">
	...
	<body>
    	...
    	<header>
			<h1>
				Girls Toys Page: <br></br> The Toy Basket: Used Toy Shop
			</h1>
